...
if(isset($_POST['create_taxe'])){
        ...
        $query = "INSERT INTO taxes(taxe_type, taxe_mont, taxe_date_em,taxe_date_rec) ";

        $query .= "VALUES('{$taxe_type}','{$taxe_mont}','{$taxe_date_em}','{$taxe_date_rec}') ";

        $create_taxe_query = mysqli_query($connection, $query);

        confirmQuery($create_taxe_query);

        array_push($success_array, "Vous avez ajouté avec succès la taxe <a href ='/compta/taxes.php'> Back </a>");
...
?>
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Ajoute Taxe</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <ol class="breadcrumb">
        <li><a href="dashboard.php">Accueil</a></li>
        <li><a href="customers.php">Taxes</a></li>
    ...
    <form action="" method="post">
        ...
        <div class="form-group col-md-8">
            ...
            <input type="text" class="form-control" name="taxe_type">
        </div>
</div>
       <div class="row">
        <div class="form-group col-md-8">
            <label for="taxe_mont">Taxe Montant</label>
            <input type="text" class="form-control" name="taxe_mont">
        </div>
</div>
        <div class="row">
            <div class="form-group col-md-4">
                <label for="taxe_date_em">Date Recu</label>
                <input type="text" data-date-format='yyyy-mm-dd' name="taxe_date_em" data-provide="datepicker" id="taxe_date_em" class="form-control" readonly placeholder="Selectionez la date">
            </div>
            <div class="form-group col-md-4">
                <label for="taxe_date_rec">Date de recouvrement</label>
                <input type="text" data-date-format='yyyy-mm-dd' name="taxe_date_rec" data-provide="datepicker" id="taxe_date_rec" class="form-control" readonly placeholder="Selectionez la date">
            </div>
        </div>
            <input class="btn btn-primary" type="submit" name="create_taxe" value="Ajout Taxe">
    </form>
